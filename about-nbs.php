...
<div class="col-lg-6">
<div class="inbnr_box">
<h2>About Nehru Business Schools</h2>
</div>
</div> 
</div>
</div>
...
<div class="row">
<div class="col-lg-12">
<div class="why_ngi_sec">
<h3 class="com_title">Why Choose Our Institution?</h3>

</div>

<div class="why-nbs-block">

<div class="col-lg-3 col-md-6">
    <div class="course-block ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/1.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Passionate Professors</h4>
            <p>Our Intellectual Capital </p>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_second ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/2.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Ranking</h4>
            <p>Business Standard, The Week Hansa research </p>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_third ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/3.jpg" alt="">
        </div>
        <div class="course-content">
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_fourth ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/4.jpg" alt="">
        </div>
        <div class="course-content">
...
<div class="col-lg-3 col-md-6">
    <div class="course-block ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/5.jpg" alt="">
        </div>
        <div class="course-content">
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_second ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/6.jpg" alt="">
        </div>
        <div class="course-content">
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_third ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/7.jpg" alt="">
        </div>
        <div class="course-content">
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_fourth ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/8.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Club activities & Community Development programs</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/9.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Outbound learning program</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_second ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/10.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Public Speaking & Spoken English Training</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_third ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/11.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Soft skills Training Sessions</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_fourth ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/12.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Internships & Consulting projects</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/13.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>International IV & Study Tour</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_second ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/14.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Regular National Industrial visits</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_third ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/15.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>NIPM Membership</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_fourth ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/16.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Well stocked Library</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block ">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/17.jpg" alt="">
        </div>
        <div class="course-content">
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_second">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/18.jpg" alt="">
        </div>
        <div class="course-content">
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_third">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/19.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>International Partners & Associates</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_fourth">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/20.jpg" alt="">
        </div>
        <div class="course-content">
            <h4>Mentoring & Proctoring Sessions</h4>
        </div>
    </div>
</div>
...
<div class="col-lg-3 col-md-6">
    <div class="course-block">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/21.jpg" alt="">
        </div>
        <div class="course-content">
...
<div class="col-lg-3 col-md-6">
    <div class="course-block cou_content_second">
        <div class="img-holder">
            <img class="img-fluid" src="images/why-nbs/22.jpg" alt="">
        </div>
        <div class="course-content">
