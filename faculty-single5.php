                ...
                <div class="single-faculty-widget">
                    <div class="team-box">
                        <div class="team-thumb">
                            <img src="images/faculty/420x420/alex-kuruvila.jpg" alt="">
                        </div>
                        <div class="team-member-info">
                            <h3>Alex Kuruvila</h3>
                            <h5>Asst Professor- NSM</h5>
                        </div>
                        <div class="team-social-widget">
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/in/alex-kuruvilla-500586210/" target="_blank"><i class="fa fa-linkedin"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <li>
                                <a href="">
                                    ...
                                    <div class="more-service-title">
                                        MBA - Marketing & Operations <span>IFIM-Bangalore[2005]</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="">
                                    ...
                                    <div class="more-service-title">
                                        BE. Mechanical <span>Bangalore University (2001)</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
